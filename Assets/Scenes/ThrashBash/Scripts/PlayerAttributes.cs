...
public class PlayerAttributes : GlobalTickReceiver
{
    ...
    public override void OnFastTick(float tickDeltaTime)
    {
        ...
        {
            ply_respawn_timer += tickDeltaTime;
        ...
        {
            air_thrust_timer += tickDeltaTime;
        }
        ...
        {
            last_hit_by_timer += tickDeltaTime;
        }
        ...
        {
            combo_send_timer += tickDeltaTime;
        }
        ...
        // Handle hazard
        if (hazard_timer < hazard_cooldown) { hazard_timer += tickDeltaTime; }
